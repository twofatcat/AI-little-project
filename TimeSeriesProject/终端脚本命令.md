...
python view_data.py --table bars_hourly_cn_2026Q1 --head 30
python view_data.py --table bars_hourly_v2_us_2026Q1 --head 10
python view_data.py --table bars_hourly_clean_cn_2026Q1 --head 10
```
